...
class StudentTest {
	...
	void testStudentStringStringStringStringStringInt() {
		...
		// first name - null
		Exception e1 = assertThrows(IllegalArgumentException.class, () -> new Student(null, LAST_NAME, ID, EMAIL, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid first name", e1.getMessage());
		// first name - empty string
		Exception e2 = assertThrows(IllegalArgumentException.class, () -> new Student("", LAST_NAME, ID, EMAIL, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid first name", e2.getMessage());
		
		// last name - null
		Exception e3 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, null, ID, EMAIL, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid last name", e3.getMessage());
		// last name - empty string
		Exception e4 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, "", ID, EMAIL, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid last name", e4.getMessage());
		
		// id - null
		Exception e5 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, LAST_NAME, null, EMAIL, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid id", e5.getMessage());
		// id - empty string
		Exception e6 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, LAST_NAME, "", EMAIL, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid id", e6.getMessage());
		
		// email - null
		Exception e7 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, LAST_NAME, ID, null, PASSWORD, MAX_CREDITS));
		assertEquals("Invalid email", e7.getMessage());
		// email - empty string
		Exception e8 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, LAST_NAME, ID, "", PASSWORD, MAX_CREDITS));
		assertEquals("Invalid email", e8.getMessage());
		// email - missing '@'
		Exception e9 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, LAST_NAME, ID, "emailncsu.edu", PASSWORD, MAX_CREDITS));
		assertEquals("Invalid email", e9.getMessage());
		// email - missing '.'
		Exception e10 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, LAST_NAME, ID, "email@ncsuedu", PASSWORD, MAX_CREDITS));
		assertEquals("Invalid email", e10.getMessage());
		// email - last '.' before first '@'
		Exception e11 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, LAST_NAME, ID, "ncsu.edu@email", PASSWORD, MAX_CREDITS));
		assertEquals("Invalid email", e11.getMessage());
		
		// password - null
		Exception e12 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, LAST_NAME, ID, EMAIL, null, MAX_CREDITS));
		assertEquals("Invalid password", e12.getMessage());
		// password - empty string
		Exception e13 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, LAST_NAME, ID, EMAIL, "", MAX_CREDITS));
		assertEquals("Invalid password", e13.getMessage());
		
		// max credits - less than minimum (by 1)
		Exception e14 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, Student.MIN_CREDITS - 1));
		assertEquals("Invalid max credits", e14.getMessage());
		// max credits - more than maximum (by 1)
		Exception e15 = assertThrows(IllegalArgumentException.class, () -> new Student(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, Student.MAX_CREDITS + 1));

...
public class Student {
	...
	/**
	 * Constructs a Student object with the given firstName, lastName, id, email and password.
	 * @param firstName Student's first name
	 * @param lastName Student's last name
	 * @param id Student's unity id
	 * @param email Student's email
	...
	/**
	 * Sets the Student's last name. If the last name is null or an empty string,
	 * an IllegalArgumentException is thrown.
	...
	/**
	 * Sets the Student's unity id. If the unity id is null or an empty string,
	 * an IllegalArgumentException is thrown.
	 * @param id Student's unity id
	...
	/**
	 * Sets the Student's email. If the email is null, an empty string, does not contain
	 * a '@' or '.' character, or if the last '.' character is earlier than the first '@'
	...
	/**
	 * Sets the Student's maximum credits hours. If maxCredits is outside the defined
